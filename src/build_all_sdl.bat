...
rem msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL_Z80B_Dbgr;Platform=Win32
rem msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL_Z80B_Dbgr;Platform=x64

msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL2_Z80B_Dbgr;Platform=Win32
msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL2_Z80B_Dbgr;Platform=x64

msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL2_M68K_Dbgr;Platform=Win32
msbuild.exe %app%_sdl.vcxproj %tag% /p:Configuration=Release_SDL2_M68K_Dbgr;Platform=x64

...
rem msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx_Z80B_Dbgr;Platform=Win32
rem msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx_Z80B_Dbgr;Platform=x64
...
msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx2_Z80B_Dbgr;Platform=Win32
msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx2_Z80B_Dbgr;Platform=x64

msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx2_M68K_Dbgr;Platform=Win32
msbuild.exe %app%_wx.vcxproj %tag% /p:Configuration=Release_Wx2_M68K_Dbgr;Platform=x64
